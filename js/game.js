...
const player = {
  width: 64, height: 42, x: 128, y: 184, speed: 420, vx: 0,
  // La imagen es grande; esta es la zona real que atrapa fruta.
  hitOffsetX: 17, hitOffsetY: 20, hitWidth: 30, hitHeight: 13
};
...
function resizeCanvas() {
  ...
  player.y = window.matchMedia("(max-width: 699px)").matches ? 154 : 184;
}
function spawnFruit() {
  const goodChance = .46;
